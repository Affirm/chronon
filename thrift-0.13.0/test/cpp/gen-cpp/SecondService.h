...
class SecondServiceClientT : virtual public SecondServiceIf {
 public:
  SecondServiceClientT(std::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  SecondServiceClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) {
...
class SecondServiceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  SecondServiceProcessorT(::std::shared_ptr<SecondServiceIf> iface) :
    iface_(iface) {
...
class SecondServiceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  SecondServiceProcessorFactoryT(const ::std::shared_ptr< SecondServiceIfFactory >& handlerFactory) :
...
class SecondServiceConcurrentClientT : virtual public SecondServiceIf {
 public:
  SecondServiceConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(prot);
  }
  SecondServiceConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(iprot,oprot);
  }
 private:
...
class SecondServiceCobClIfT {
 public:
   ...
   * @param thing
   */
  virtual void secondtestString(::std::function<void(SecondServiceCobClientT<Protocol_>* client)> cob, const std::string& thing) = 0;
};
...
class SecondServiceCobSvIf {
 public:
   ...
   * @param thing
   */
  virtual void secondtestString(::std::function<void(std::string const& _return)> cob, const std::string& thing) = 0;
};
...
class SecondServiceCobSvIfSingletonFactory : virtual public SecondServiceCobSvIfFactory {
 public:
  SecondServiceCobSvIfSingletonFactory(const ::std::shared_ptr<SecondServiceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<SecondServiceCobSvIf> iface_;
};

class SecondServiceCobSvNull : virtual public SecondServiceCobSvIf {
 public:
  virtual ~SecondServiceCobSvNull() {}
  void secondtestString(::std::function<void(std::string const& _return)> cob, const std::string& /* thing */) {
    std::string _return;
    return cob(_return);
  }
};
...
class SecondServiceCobClientT : virtual public SecondServiceCobClIfT<Protocol_> {
 public:
  SecondServiceCobClientT(std::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void secondtestString(::std::function<void(SecondServiceCobClientT<Protocol_>* client)> cob, const std::string& thing);
  void send_secondtestString(const std::string& thing);
  void recv_secondtestString(std::string& _return);
 protected:
...
class SecondServiceAsyncProcessorT : public ::apache::thrift::async::TAsyncDispatchProcessorT<Protocol_> {
 ...
 private:
  typedef  void (SecondServiceAsyncProcessorT::*ProcessFunction)(::std::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef void (SecondServiceAsyncProcessorT::*SpecializedProcessFunction)(::std::function<void(bool ok)>, int32_t, Protocol_*, Protocol_*);
  struct ProcessFunctions {
    ProcessFunction generic;
    SpecializedProcessFunction specialized;
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s) :
  ...
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void return_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  void throw_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_secondtestString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  SecondServiceAsyncProcessorT(::std::shared_ptr<SecondServiceCobSvIf> iface) :
    iface_(iface) {
    processMap_["secondtestString"] = ProcessFunctions(
...
class SecondServiceAsyncProcessorFactoryT : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  SecondServiceAsyncProcessorFactoryT(const ::std::shared_ptr< SecondServiceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< SecondServiceCobSvIfFactory > handlerFactory_;
};
