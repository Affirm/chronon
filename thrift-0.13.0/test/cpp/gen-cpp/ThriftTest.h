...
class ThriftTestClientT : virtual public ThriftTestIf {
 public:
  ThriftTestClientT(std::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  ThriftTestClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) {
...
class ThriftTestProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  ThriftTestProcessorT(::std::shared_ptr<ThriftTestIf> iface) :
    iface_(iface) {
...
class ThriftTestProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  ThriftTestProcessorFactoryT(const ::std::shared_ptr< ThriftTestIfFactory >& handlerFactory) :
...
class ThriftTestConcurrentClientT : virtual public ThriftTestIf {
 public:
  ThriftTestConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(prot);
  }
  ThriftTestConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(iprot,oprot);
  }
 private:
...
class ThriftTestCobClIfT {
 public:
   ...
   * Prints "testVoid()" and returns nothing.
   */
  virtual void testVoid(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob) = 0;
   ...
   * @param thing
   */
  virtual void testString(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing) = 0;
   ...
   * @param thing
   */
  virtual void testBool(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const bool thing) = 0;
   ...
   * @param thing
   */
  virtual void testByte(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testI32(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testI64(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int64_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testDouble(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const double thing) = 0;
   ...
   * @param thing
   */
  virtual void testBinary(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing) = 0;
   ...
   * @param thing
   */
  virtual void testStruct(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct& thing) = 0;
   ...
   * @param thing
   */
  virtual void testNest(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct2& thing) = 0;
   ...
   * @param thing
   */
  virtual void testMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<int32_t, int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testStringMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<std::string, std::string> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testSet(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::set<int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testList(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::vector<int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testEnum(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Numberz::type thing) = 0;
   ...
   * @param thing
   */
  virtual void testTypedef(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const UserId thing) = 0;
   ...
   * @param hello
   */
  virtual void testMapMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t hello) = 0;
   ...
   * @param argument
   */
  virtual void testInsanity(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Insanity& argument) = 0;
   ...
   * @param arg5
   */
  virtual void testMulti(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5) = 0;
   ...
   * @param arg
   */
  virtual void testException(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg) = 0;
   ...
   * @param arg1
   */
  virtual void testMultiException(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg0, const std::string& arg1) = 0;
   ...
   * @param secondsToSleep
   */
  virtual void testOneway(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t secondsToSleep) = 0;
};
...
class ThriftTestCobSvIf {
 public:
   ...
   * Prints "testVoid()" and returns nothing.
   */
  virtual void testVoid(::std::function<void()> cob) = 0;
   ...
   * @param thing
   */
  virtual void testBool(::std::function<void(bool const& _return)> cob, const bool thing) = 0;
   ...
   * @param thing
   */
  virtual void testByte(::std::function<void(int8_t const& _return)> cob, const int8_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testI32(::std::function<void(int32_t const& _return)> cob, const int32_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testI64(::std::function<void(int64_t const& _return)> cob, const int64_t thing) = 0;
   ...
   * @param thing
   */
  virtual void testDouble(::std::function<void(double const& _return)> cob, const double thing) = 0;
   ...
   * @param thing
   */
  virtual void testBinary(::std::function<void(std::string const& _return)> cob, const std::string& thing) = 0;
   ...
   * @param thing
   */
  virtual void testStruct(::std::function<void(Xtruct const& _return)> cob, const Xtruct& thing) = 0;
   ...
   * @param thing
   */
  virtual void testNest(::std::function<void(Xtruct2 const& _return)> cob, const Xtruct2& thing) = 0;
   ...
   * @param thing
   */
  virtual void testMap(::std::function<void(std::map<int32_t, int32_t>  const& _return)> cob, const std::map<int32_t, int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testStringMap(::std::function<void(std::map<std::string, std::string>  const& _return)> cob, const std::map<std::string, std::string> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testSet(::std::function<void(std::set<int32_t>  const& _return)> cob, const std::set<int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testList(::std::function<void(std::vector<int32_t>  const& _return)> cob, const std::vector<int32_t> & thing) = 0;
   ...
   * @param thing
   */
  virtual void testEnum(::std::function<void(Numberz::type const& _return)> cob, const Numberz::type thing) = 0;
   ...
   * @param thing
   */
  virtual void testTypedef(::std::function<void(UserId const& _return)> cob, const UserId thing) = 0;
   ...
   * @param hello
   */
  virtual void testMapMap(::std::function<void(std::map<int32_t, std::map<int32_t, int32_t> >  const& _return)> cob, const int32_t hello) = 0;
   ...
   * @param argument
   */
  virtual void testInsanity(::std::function<void(std::map<UserId, std::map<Numberz::type, Insanity> >  const& _return)> cob, const Insanity& argument) = 0;
   ...
   * @param arg5
   */
  virtual void testMulti(::std::function<void(Xtruct const& _return)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5) = 0;
   ...
   * @param arg
   */
  virtual void testException(::std::function<void()> cob, ::std::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& arg) = 0;
   ...
   * @param arg1
   */
  virtual void testMultiException(::std::function<void(Xtruct const& _return)> cob, ::std::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& arg0, const std::string& arg1) = 0;
   ...
   * @param secondsToSleep
   */
  virtual void testOneway(::std::function<void()> cob, const int32_t secondsToSleep) = 0;
};
...
class ThriftTestCobSvIfSingletonFactory : virtual public ThriftTestCobSvIfFactory {
 public:
  ThriftTestCobSvIfSingletonFactory(const ::std::shared_ptr<ThriftTestCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<ThriftTestCobSvIf> iface_;
};

class ThriftTestCobSvNull : virtual public ThriftTestCobSvIf {
 public:
  virtual ~ThriftTestCobSvNull() {}
  void testVoid(::std::function<void()> cob) {
    return cob();
  }
  void testString(::std::function<void(std::string const& _return)> cob, const std::string& /* thing */) {
    std::string _return;
    return cob(_return);
  }
  void testBool(::std::function<void(bool const& _return)> cob, const bool /* thing */) {
    bool _return = false;
    return cob(_return);
  }
  void testByte(::std::function<void(int8_t const& _return)> cob, const int8_t /* thing */) {
    int8_t _return = 0;
    return cob(_return);
  }
  void testI32(::std::function<void(int32_t const& _return)> cob, const int32_t /* thing */) {
    int32_t _return = 0;
    return cob(_return);
  }
  void testI64(::std::function<void(int64_t const& _return)> cob, const int64_t /* thing */) {
    int64_t _return = 0;
    return cob(_return);
  }
  void testDouble(::std::function<void(double const& _return)> cob, const double /* thing */) {
    double _return = (double)0;
    return cob(_return);
  }
  void testBinary(::std::function<void(std::string const& _return)> cob, const std::string& /* thing */) {
    std::string _return;
    return cob(_return);
  }
  void testStruct(::std::function<void(Xtruct const& _return)> cob, const Xtruct& /* thing */) {
    Xtruct _return;
    return cob(_return);
  }
  void testNest(::std::function<void(Xtruct2 const& _return)> cob, const Xtruct2& /* thing */) {
    Xtruct2 _return;
    return cob(_return);
  }
  void testMap(::std::function<void(std::map<int32_t, int32_t>  const& _return)> cob, const std::map<int32_t, int32_t> & /* thing */) {
    std::map<int32_t, int32_t>  _return;
    return cob(_return);
  }
  void testStringMap(::std::function<void(std::map<std::string, std::string>  const& _return)> cob, const std::map<std::string, std::string> & /* thing */) {
    std::map<std::string, std::string>  _return;
    return cob(_return);
  }
  void testSet(::std::function<void(std::set<int32_t>  const& _return)> cob, const std::set<int32_t> & /* thing */) {
    std::set<int32_t>  _return;
    return cob(_return);
  }
  void testList(::std::function<void(std::vector<int32_t>  const& _return)> cob, const std::vector<int32_t> & /* thing */) {
    std::vector<int32_t>  _return;
    return cob(_return);
  }
  void testEnum(::std::function<void(Numberz::type const& _return)> cob, const Numberz::type /* thing */) {
    Numberz::type _return = (Numberz::type)0;
    return cob(_return);
  }
  void testTypedef(::std::function<void(UserId const& _return)> cob, const UserId /* thing */) {
    UserId _return = 0;
    return cob(_return);
  }
  void testMapMap(::std::function<void(std::map<int32_t, std::map<int32_t, int32_t> >  const& _return)> cob, const int32_t /* hello */) {
    std::map<int32_t, std::map<int32_t, int32_t> >  _return;
    return cob(_return);
  }
  void testInsanity(::std::function<void(std::map<UserId, std::map<Numberz::type, Insanity> >  const& _return)> cob, const Insanity& /* argument */) {
    std::map<UserId, std::map<Numberz::type, Insanity> >  _return;
    return cob(_return);
  }
  void testMulti(::std::function<void(Xtruct const& _return)> cob, const int8_t /* arg0 */, const int32_t /* arg1 */, const int64_t /* arg2 */, const std::map<int16_t, std::string> & /* arg3 */, const Numberz::type /* arg4 */, const UserId /* arg5 */) {
    Xtruct _return;
    return cob(_return);
  }
  void testException(::std::function<void()> cob, ::std::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* arg */) {
    return cob();
  }
  void testMultiException(::std::function<void(Xtruct const& _return)> cob, ::std::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* arg0 */, const std::string& /* arg1 */) {
    Xtruct _return;
    return cob(_return);
  }
  void testOneway(::std::function<void()> cob, const int32_t /* secondsToSleep */) {
    return cob();
  }
};
...
class ThriftTestCobClientT : virtual public ThriftTestCobClIfT<Protocol_> {
 public:
  ThriftTestCobClientT(std::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void testVoid(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob);
  void send_testVoid();
  void recv_testVoid();
  void testString(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing);
  void send_testString(const std::string& thing);
  void recv_testString(std::string& _return);
  void testBool(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const bool thing);
  void send_testBool(const bool thing);
  bool recv_testBool();
  void testByte(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t thing);
  void send_testByte(const int8_t thing);
  int8_t recv_testByte();
  void testI32(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t thing);
  void send_testI32(const int32_t thing);
  int32_t recv_testI32();
  void testI64(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int64_t thing);
  void send_testI64(const int64_t thing);
  int64_t recv_testI64();
  void testDouble(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const double thing);
  void send_testDouble(const double thing);
  double recv_testDouble();
  void testBinary(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing);
  void send_testBinary(const std::string& thing);
  void recv_testBinary(std::string& _return);
  void testStruct(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct& thing);
  void send_testStruct(const Xtruct& thing);
  void recv_testStruct(Xtruct& _return);
  void testNest(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct2& thing);
  void send_testNest(const Xtruct2& thing);
  void recv_testNest(Xtruct2& _return);
  void testMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<int32_t, int32_t> & thing);
  void send_testMap(const std::map<int32_t, int32_t> & thing);
  void recv_testMap(std::map<int32_t, int32_t> & _return);
  void testStringMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<std::string, std::string> & thing);
  void send_testStringMap(const std::map<std::string, std::string> & thing);
  void recv_testStringMap(std::map<std::string, std::string> & _return);
  void testSet(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::set<int32_t> & thing);
  void send_testSet(const std::set<int32_t> & thing);
  void recv_testSet(std::set<int32_t> & _return);
  void testList(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::vector<int32_t> & thing);
  void send_testList(const std::vector<int32_t> & thing);
  void recv_testList(std::vector<int32_t> & _return);
  void testEnum(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Numberz::type thing);
  void send_testEnum(const Numberz::type thing);
  Numberz::type recv_testEnum();
  void testTypedef(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const UserId thing);
  void send_testTypedef(const UserId thing);
  UserId recv_testTypedef();
  void testMapMap(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t hello);
  void send_testMapMap(const int32_t hello);
  void recv_testMapMap(std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void testInsanity(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Insanity& argument);
  void send_testInsanity(const Insanity& argument);
  void recv_testInsanity(std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void testMulti(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5);
  void send_testMulti(const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5);
  void recv_testMulti(Xtruct& _return);
  void testException(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg);
  void send_testException(const std::string& arg);
  void recv_testException();
  void testMultiException(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg0, const std::string& arg1);
  void send_testMultiException(const std::string& arg0, const std::string& arg1);
  void recv_testMultiException(Xtruct& _return);
  void testOneway(::std::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t secondsToSleep);
  void send_testOneway(const int32_t secondsToSleep);
 protected:
...
class ThriftTestAsyncProcessorT : public ::apache::thrift::async::TAsyncDispatchProcessorT<Protocol_> {
 protected:
  ::std::shared_ptr<ThriftTestCobSvIf> iface_;
  virtual void dispatchCall(::std::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid);
 ...
 private:
  typedef  void (ThriftTestAsyncProcessorT::*ProcessFunction)(::std::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef void (ThriftTestAsyncProcessorT::*SpecializedProcessFunction)(::std::function<void(bool ok)>, int32_t, Protocol_*, Protocol_*);
  struct ProcessFunctions {
    ProcessFunction generic;
    SpecializedProcessFunction specialized;
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s) :
  ...
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testVoid(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_testString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  ...
  void return_testString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  ...
  void throw_testString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testBool(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testBool(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testBool(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void return_testBool(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const bool& _return);
  void throw_testBool(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testBool(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testByte(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testByte(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testByte(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int8_t& _return);
  void return_testByte(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int8_t& _return);
  void throw_testByte(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testByte(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testI32(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testI32(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testI32(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_testI32(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_testI32(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testI32(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testI64(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testI64(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testI64(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int64_t& _return);
  void return_testI64(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int64_t& _return);
  void throw_testI64(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testI64(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const double& _return);
  void return_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const double& _return);
  void throw_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testDouble(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void return_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  void throw_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testBinary(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testStruct(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testNest(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testNest(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testNest(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct2& _return);
  void return_testNest(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct2& _return);
  void throw_testNest(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testNest(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<int32_t, int32_t> & _return);
  void return_testMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<int32_t, int32_t> & _return);
  void throw_testMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<std::string, std::string> & _return);
  void return_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<std::string, std::string> & _return);
  void throw_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testStringMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testSet(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testSet(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testSet(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<int32_t> & _return);
  void return_testSet(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::set<int32_t> & _return);
  void throw_testSet(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testSet(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testList(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testList(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testList(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<int32_t> & _return);
  void return_testList(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<int32_t> & _return);
  void throw_testList(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testList(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Numberz::type& _return);
  void return_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Numberz::type& _return);
  void throw_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testEnum(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const UserId& _return);
  void return_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const UserId& _return);
  void throw_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testTypedef(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void return_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void throw_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testMapMap(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void return_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void throw_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testInsanity(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testMulti(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testMultiException(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testOneway(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  ThriftTestAsyncProcessorT(::std::shared_ptr<ThriftTestCobSvIf> iface) :
    iface_(iface) {
    processMap_["testVoid"] = ProcessFunctions(
...
class ThriftTestAsyncProcessorFactoryT : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  ThriftTestAsyncProcessorFactoryT(const ::std::shared_ptr< ThriftTestCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< ThriftTestCobSvIfFactory > handlerFactory_;
};
