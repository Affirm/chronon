        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i328 = 0; _i328 < _size324; ++_i328)
            {
              ...
              std::string& _val330 = this->thing[_key329];
...
uint32_t ThriftTest_testStringMap_pargs::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    for (_iter332 = (*(this->thing)).begin(); _iter332 != (*(this->thing)).end(); ++_iter332)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i337 = 0; _i337 < _size333; ++_i337)
            {
              ...
              std::string& _val339 = this->success[_key338];
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i345 = 0; _i345 < _size341; ++_i345)
            {
              ...
              std::string& _val347 = (*(this->success))[_key346];
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            {
              int32_t _elem354;
              xfer += iprot->readI32(_elem354);
              this->thing.insert(_elem354);
            }
...
uint32_t ThriftTest_testSet_args::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_SET, 1);
  {
    ...
    std::set<int32_t> ::const_iterator _iter355;
    for (_iter355 = this->thing.begin(); _iter355 != this->thing.end(); ++_iter355)
    {
...
uint32_t ThriftTest_testSet_pargs::write(Protocol_* oprot) const {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>((*(this->thing)).size()));
    std::set<int32_t> ::const_iterator _iter356;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->thing.resize(_size371);
            uint32_t _i375;
            for (_i375 = 0; _i375 < _size371; ++_i375)
            {
              xfer += iprot->readI32(this->thing[_i375]);
            }
...
uint32_t ThriftTest_testList_args::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter376 = this->thing.begin(); _iter376 != this->thing.end(); ++_iter376)
    {
...
uint32_t ThriftTest_testList_pargs::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter377 = (*(this->thing)).begin(); _iter377 != (*(this->thing)).end(); ++_iter377)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI32(this->success[_i382]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t ThriftTest_testList_result::write(Protocol_* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<int32_t> ::const_iterator _iter383;
      for (_iter383 = this->success.begin(); _iter383 != this->success.end(); ++_iter383)
      {
        xfer += oprot->writeI32((*_iter383));
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI32((*(this->success))[_i388]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->thing = (Numberz::type)ecast390;
          this->__isset.thing = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (Numberz::type)ecast391;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (Numberz::type)ecast392;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key398;
              xfer += iprot->readI32(_key398);
              std::map<int32_t, int32_t> & _val399 = this->success[_key398];
              {
                _val399.clear();
                uint32_t _size400;
                ...
                for (_i404 = 0; _i404 < _size400; ++_i404)
                {
                  ...
                  int32_t& _val406 = _val399[_key405];
                  xfer += iprot->readI32(_val406);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t ThriftTest_testMapMap_result::write(Protocol_* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_MAP, 0);
    {
      ...
      std::map<int32_t, std::map<int32_t, int32_t> > ::const_iterator _iter407;
      for (_iter407 = this->success.begin(); _iter407 != this->success.end(); ++_iter407)
      {
        xfer += oprot->writeI32(_iter407->first);
        {
          xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I32, static_cast<uint32_t>(_iter407->second.size()));
          std::map<int32_t, int32_t> ::const_iterator _iter408;
          for (_iter408 = _iter407->second.begin(); _iter408 != _iter407->second.end(); ++_iter408)
          {
            xfer += oprot->writeI32(_iter408->first);
            xfer += oprot->writeI32(_iter408->second);
          }
          xfer += oprot->writeMapEnd();
        }
      }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key414;
              xfer += iprot->readI32(_key414);
              std::map<int32_t, int32_t> & _val415 = (*(this->success))[_key414];
              {
                _val415.clear();
                uint32_t _size416;
                ...
                {
                  int32_t _key421;
                  xfer += iprot->readI32(_key421);
                  int32_t& _val422 = _val415[_key421];
                  xfer += iprot->readI32(_val422);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t ThriftTest_testMapMap_presult::write(Protocol_* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_MAP, static_cast<uint32_t>((*(this->success)).size()));
    std::map<int32_t, std::map<int32_t, int32_t> > ::const_iterator _iter423;
    for (_iter423 = (*(this->success)).begin(); _iter423 != (*(this->success)).end(); ++_iter423)
    {
      xfer += oprot->writeI32(_iter423->first);
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I32, static_cast<uint32_t>(_iter423->second.size()));
        std::map<int32_t, int32_t> ::const_iterator _iter424;
        for (_iter424 = _iter423->second.begin(); _iter424 != _iter423->second.end(); ++_iter424)
        {
          xfer += oprot->writeI32(_iter424->first);
          xfer += oprot->writeI32(_iter424->second);
        }
        xfer += oprot->writeMapEnd();
      }
    }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              UserId _key430;
              xfer += iprot->readI64(_key430);
              std::map<Numberz::type, Insanity> & _val431 = this->success[_key430];
              {
                _val431.clear();
                uint32_t _size432;
                ...
                {
                  Numberz::type _key437;
                  int32_t ecast439;
                  xfer += iprot->readI32(ecast439);
                  _key437 = (Numberz::type)ecast439;
                  Insanity& _val438 = _val431[_key437];
                  xfer += _val438.read(iprot);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t ThriftTest_testInsanity_result::write(Protocol_* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_MAP, 0);
    {
      ...
      std::map<UserId, std::map<Numberz::type, Insanity> > ::const_iterator _iter440;
      for (_iter440 = this->success.begin(); _iter440 != this->success.end(); ++_iter440)
      {
        xfer += oprot->writeI64(_iter440->first);
        {
          xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter440->second.size()));
          std::map<Numberz::type, Insanity> ::const_iterator _iter441;
          for (_iter441 = _iter440->second.begin(); _iter441 != _iter440->second.end(); ++_iter441)
          {
            xfer += oprot->writeI32((int32_t)_iter441->first);
            xfer += _iter441->second.write(oprot);
          }
          xfer += oprot->writeMapEnd();
        }
      }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i446 = 0; _i446 < _size442; ++_i446)
            {
              ...
              std::map<Numberz::type, Insanity> & _val448 = (*(this->success))[_key447];
              {
                _val448.clear();
                uint32_t _size449;
                ...
                {
                  Numberz::type _key454;
                  int32_t ecast456;
                  xfer += iprot->readI32(ecast456);
                  _key454 = (Numberz::type)ecast456;
                  Insanity& _val455 = _val448[_key454];
                  xfer += _val455.read(iprot);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t ThriftTest_testInsanity_presult::write(Protocol_* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I64, ::apache::thrift::protocol::T_MAP, static_cast<uint32_t>((*(this->success)).size()));
    std::map<UserId, std::map<Numberz::type, Insanity> > ::const_iterator _iter457;
    for (_iter457 = (*(this->success)).begin(); _iter457 != (*(this->success)).end(); ++_iter457)
    {
      xfer += oprot->writeI64(_iter457->first);
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter457->second.size()));
        std::map<Numberz::type, Insanity> ::const_iterator _iter458;
        for (_iter458 = _iter457->second.begin(); _iter458 != _iter457->second.end(); ++_iter458)
        {
          xfer += oprot->writeI32((int32_t)_iter458->first);
          xfer += _iter458->second.write(oprot);
        }
        xfer += oprot->writeMapEnd();
      }
    }
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int16_t _key464;
              xfer += iprot->readI16(_key464);
              std::string& _val465 = this->arg3[_key464];
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->arg4 = (Numberz::type)ecast466;
...
uint32_t ThriftTest_testMulti_args::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("arg3", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    std::map<int16_t, std::string> ::const_iterator _iter467;
    for (_iter467 = this->arg3.begin(); _iter467 != this->arg3.end(); ++_iter467)
    {
      xfer += oprot->writeI16(_iter467->first);
...
uint32_t ThriftTest_testMulti_pargs::write(Protocol_* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I16, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>((*(this->arg3)).size()));
    std::map<int16_t, std::string> ::const_iterator _iter468;
    for (_iter468 = (*(this->arg3)).begin(); _iter468 != (*(this->arg3)).end(); ++_iter468)
    {
      xfer += oprot->writeI16(_iter468->first);
